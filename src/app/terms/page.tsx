        ...
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <div className="space-y-8 text-gray-300">
            <section>
              ...
              <p>
                By accessing or using MyMedVisit ("the App"), you agree to be
            ...
            <section>
              ...
              <div className="bg-yellow-900/20 border border-yellow-600/50 rounded-lg p-6 mb-4">
                ...
                <p>
                  MyMedVisit is NOT a substitute for professional medical
                  ...
                  because of information obtained through MyMedVisit.
                </p>
              </div>
              <p className="mt-4">
                The App provides general health information and insights based
                on AI processing. This information is for educational and
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                limited license to use the App subject to these Terms. You may
                not:
              </p>
            ...
            <section>
              ...
              <div className="bg-red-900/20 border border-red-600/50 rounded-lg p-6">
                ...
                <p>
                  DO NOT USE THIS APP. Call 911 (or your local emergency number)
                  immediately. MyMedVisit is not designed for emergency
                  situations and should never be used as a substitute for
            ...
            <section>
              ...
              <p>
                While we strive to provide accurate and up-to-date health
                information, we make no representations or warranties of any
                kind about the completeness, accuracy, reliability, or
                availability of the information provided through the App.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                of your information as described in our{' '}
                <Link
                  href="/privacy"
            ...
            <section>
              ...
              <p>
                ...
                are owned by MyMedVisit and are protected by international
            ...
            <section>
              ...
              <p className="mt-4">
                These services have their own terms and conditions, and we are
                not responsible for their practices or content.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                If you separately opt in through our SMS opt-in page,
                MyMedVisit, operated by SUGARCANEHAYES, may send one-time
            ...
            <section>
              ...
              <p>
                To the maximum extent permitted by law, MyMedVisit shall not be
              ...
              <ul className="list-disc list-inside space-y-2 ml-4 mt-4">
                ...
                <li>
                  Any bugs, viruses, or the like that may be transmitted through
                  the App
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                You agree to indemnify and hold harmless MyMedVisit and its
                officers, directors, employees, and agents from any claims,
                damages, losses, liabilities, and expenses (including legal
                fees) arising out of your use of the App or violation of these
                Terms.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-4">
                Email:{' '}
                <a
                  href="mailto:legal@mymedvisit.app"
                  className="text-[#1aa99a] hover:underline"
                >
