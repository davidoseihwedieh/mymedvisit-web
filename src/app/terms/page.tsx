        ...
        <div className="space-y-8 text-gray-300">
          ...
          <section>
            ...
            <div className="bg-yellow-900/20 border border-yellow-600/50 rounded-lg p-6 mb-4">
              ...
              <p>
                MyMedVisit is NOT a substitute for professional medical advice,
                ...
                information obtained through MyMedVisit.
              </p>
            </div>
            <p className="mt-4">
              The App provides general health information and insights based on
              AI processing. This information is for educational and
          ...
          <section>
            ...
            <p className="mb-4">
              ...
              license to use the App subject to these Terms. You may not:
            </p>
          ...
          <section>
            ...
            <div className="bg-red-900/20 border border-red-600/50 rounded-lg p-6">
              ...
              <p>
                ...
                immediately. MyMedVisit is not designed for emergency situations
                and should never be used as a substitute for emergency medical
                services.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              using the App, you consent to the collection, use, and sharing of
              your information as described in our{' '}
              <Link href="/privacy" className="text-[#1aa99a] hover:underline">
                Privacy Policy
              </Link>
              .
            </p>
          ...
          <section>
            ...
            <p>
              ...
              owned by MyMedVisit and are protected by international copyright,
          ...
          <section>
            ...
            <p className="mb-4">The App uses third-party services including:</p>
            <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <p className="mt-4">
              These services have their own terms and conditions, and we are not
          ...
          <section>
            ...
            <p>
              If you separately opt in through our SMS opt-in page, MyMedVisit
              may send transactional text messages for one-time verification
              codes, account security, and requested service notifications.
              Message frequency varies and message and data rates may apply.
              Reply STOP to opt out and HELP for help. SMS consent is not a
              condition of purchase and does not authorize advertising or
          ...
          <section>
            ...
            <p>
              ...
              the App after changes become effective constitutes acceptance of
              the updated Terms.
            </p>
          </section>
